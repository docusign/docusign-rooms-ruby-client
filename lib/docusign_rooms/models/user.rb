...
module DocuSign_Rooms
  class User
    ...
    def hash
      [user_id, email, first_name, last_name, is_locked_out, status, access_level, default_office_id, title_id, role_id, profile_image_url, offices, regions, permissions].hash
    end

...
module DocuSign_Rooms
  class ClassicManagerToInvite
    ...
    def list_invalid_properties
      ...
      if @title_id.nil?
        invalid_properties.push('invalid value for "title_id", title_id cannot be nil.')
      end
    ...
    def hash
      [first_name, last_name, email, default_office_id, title_id, access_level, permissions, offices, regions, e_sign_permission_profile_id].hash
    end

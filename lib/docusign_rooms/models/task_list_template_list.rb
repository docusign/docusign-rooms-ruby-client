...
module DocuSign_Rooms
  class TaskListTemplateList
    attr_accessor :task_list_templates
    ...
    def self.swagger_types
      {
        :'task_list_templates' => :'Array<TaskListTemplate>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'taskListTemplates')
        if (value = attributes[:'taskListTemplates']).is_a?(Array)
          self.task_list_templates = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          task_list_templates == o.task_list_templates &&

...
module DocuSign_Rooms
  class FormDetails
    ...
    attr_accessor :available_on_date
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'availableOnDate')
        self.available_on_date = attributes[:'availableOnDate']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          available_on_date == o.available_on_date &&
    ...
    def hash
      [form_id, name, created_date, last_updated_date, available_on_date, owner_name, version, number_of_pages].hash
    end

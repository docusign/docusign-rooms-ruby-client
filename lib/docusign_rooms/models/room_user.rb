...
module DocuSign_Rooms
  class RoomUser
    ...
    attr_accessor :invited_by_user_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isRevoked')
        self.is_revoked = attributes[:'isRevoked']
      end

      if attributes.has_key?(:'invitedByUserId')
        self.invited_by_user_id = attributes[:'invitedByUserId']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          invited_by_user_id == o.invited_by_user_id
    end
    ...
    def hash
      [user_id, email, first_name, last_name, transaction_side_id, role_id, is_revoked, invited_by_user_id].hash
    end

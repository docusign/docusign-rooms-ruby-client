...
module DocuSign_Rooms
  class TaskList
    ...
    def hash
      [task_list_id, name, task_list_template_id, submitted_for_review_date, approval_date, rejected_date, created_date, approved_by_user_id, rejected_by_user_id, comment, tasks].hash
    end

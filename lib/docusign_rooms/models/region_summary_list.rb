...
module DocuSign_Rooms
  class RegionSummaryList
    attr_accessor :region_summaries
    ...
    def self.swagger_types
      {
        :'region_summaries' => :'Array<RegionSummary>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'regionSummaries')
        if (value = attributes[:'regionSummaries']).is_a?(Array)
          self.region_summaries = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          region_summaries == o.region_summaries &&
    ...
    def hash
      [region_summaries, result_set_size, start_position, end_position, next_uri, prior_uri, total_row_count].hash
    end

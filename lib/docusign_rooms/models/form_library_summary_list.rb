...
module DocuSign_Rooms
  class FormLibrarySummaryList
    attr_accessor :forms_library_summaries
    ...
    def self.swagger_types
      {
        :'forms_library_summaries' => :'Array<FormLibrarySummary>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'formsLibrarySummaries')
        if (value = attributes[:'formsLibrarySummaries']).is_a?(Array)
          self.forms_library_summaries = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          forms_library_summaries == o.forms_library_summaries &&

...
module DocuSign_Rooms
  class RoomTemplatesSummaryList
    attr_accessor :room_templates
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'roomTemplates')
        if (value = attributes[:'roomTemplates']).is_a?(Array)
          self.room_templates = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          room_templates == o.room_templates &&

...
module DocuSign_Rooms
  class FieldConfiguration
    ...
    def self.swagger_types
      {
        ...
        :'depends_on' => :'Array<DependsOn>',
        :'options' => :'Array<SelectListFieldOption>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isPublisher')
        self.is_publisher = attributes[:'isPublisher']
      end

      if attributes.has_key?(:'dependsOn')
        if (value = attributes[:'dependsOn']).is_a?(Array)
    ...
    def hash
      [max_value, min_value, multiple_of, max_length, min_length, pattern, is_publisher, depends_on, options].hash
    end

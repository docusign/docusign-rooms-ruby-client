...
module DocuSign_Rooms
  class FormGroupSummaryList
    attr_accessor :form_groups
    ...
    def self.swagger_types
      {
        :'form_groups' => :'Array<FormGroupSummary>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'formGroups')
        if (value = attributes[:'formGroups']).is_a?(Array)
          self.form_groups = value
        end
      end

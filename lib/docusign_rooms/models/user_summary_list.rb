...
module DocuSign_Rooms
  class UserSummaryList
    ...
    def self.swagger_types
      {
        :'user_summaries' => :'Array<UserSummary>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'userSummaries')
        if (value = attributes[:'userSummaries']).is_a?(Array)
          self.user_summaries = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          user_summaries == o.user_summaries &&
